...
[![PyPI version](https://badge.fury.io/py/terch.svg)](https://pypi.org/project/terch/)
...
`terch` is published on PyPI: [pypi.org/project/terch](https://pypi.org/project/terch/)
